 ...
 */
public class Tata_cara_sholat extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.tata_cara_sholat, container, false);
        RecyclerView recyclerView = (RecyclerView) v.findViewById(R.id.list_tatacarasholat);
        texthead = getResources().getStringArray(R.array.tatacarasholat);
        textdsc = getResources().getStringArray(R.array.desc_tatacara_sholat);
